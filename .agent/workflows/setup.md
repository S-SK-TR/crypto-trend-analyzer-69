...
- `CLAUDE.md` dosyasındaki `BtcAnaliz: Bitcoin ve Kripto Piyasa Analizi Platformu`, `BtcAnaliz: Bitcoin ve Kripto Piyasa Analizi Platformu — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
